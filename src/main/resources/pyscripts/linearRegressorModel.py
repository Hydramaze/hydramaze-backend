...
def regressor(loaded_dataset):
    ...
    return json.dumps({"status": "success", "data": {"accuracy": {"name": "R2 Score","value": r2_score_value, "reference": "http://scikit-learn.org/stable/modules/generated/sklearn.metrics.r2_score.html#sklearn-metrics-r2-score"}}}, sort_keys=True, separators=(',', ':'))
